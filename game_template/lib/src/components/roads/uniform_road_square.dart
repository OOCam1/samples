...
class UniformRoadSquare extends RoadSquare {
  ...
  UniformRoadSquare(double gridSquareHorizontalSize,
      double gridSquareVerticalSize, Vector2 position, int priority) {
    ...
    _base = UniformGridSquare(Vector2(width / 2, height / 2), _baseColor,
